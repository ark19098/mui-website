...
import {Tooltip, Fab, Modal, Box, Typography, Avatar, TextField, Stack, ButtonGroup, Button, styled} from '@mui/material';
    ...
    >
      <Box width={400} height={280} bgcolor={"background.default"} color={"text.primary"} p={3} borderRadius={5}>
        ...
        <UserBox>
          <Avatar
            alt="Remy Sharp"
            src="https://avatars.githubusercontent.com/u/13700?v=4"
